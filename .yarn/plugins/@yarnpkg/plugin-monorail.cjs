...
var plugin=(()=>{var U=Object.create,f=Object.defineProperty,K=Object.defineProperties,V=Object.getOwnPropertyDescriptor,z=Object.getOwnPropertyDescriptors,Q=Object.getOwnPropertyNames,h=Object.getOwnPropertySymbols,X=Object.getPrototypeOf,C=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var W=(n,e,r)=>e in n?f(n,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):n[e]=r,T=(n,e)=>{for(var r in e||(e={}))C.call(e,r)&&W(n,r,e[r]);if(h)for(var r of h(e))F.call(e,r)&&W(n,r,e[r]);return n},Y=(n,e)=>K(n,z(e)),Z=n=>f(n,"__esModule",{value:!0});var m=n=>{if(typeof require!="undefined")return require(n);throw new Error('Dynamic require of "'+n+'" is not supported')};var x=(n,e)=>{var r={};for(var o in n)C.call(n,o)&&e.indexOf(o)<0&&(r[o]=n[o]);if(n!=null&&h)for(var o of h(n))e.indexOf(o)<0&&F.call(n,o)&&(r[o]=n[o]);return r},nn=(n,e)=>()=>(n&&(e=n(n=0)),e);var A=(n,e)=>{for(var r in e)f(n,r,{get:e[r],enumerable:!0})},en=(n,e,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of Q(e))!C.call(n,o)&&o!=="default"&&f(n,o,{get:()=>e[o],enumerable:!(r=V(e,o))||r.enumerable});return n},u=n=>en(Z(f(n!=null?U(X(n)):{},"default",n&&n.__esModule&&"default"in n?{get:()=>n.default,enumerable:!0}:{value:n,enumerable:!0})),n);var B={};A(B,{default:()=>gn});var R,b,J,un,gn,G=nn(()=>{R=u(m("child_process")),b=(()=>{let n=new Map,o=`[${(0,R.spawnSync)("yarn",["workspaces","list","-v","--json"]).stdout.toString().trim().split(`
...
`]})],k=(0,S.join)(".github","workflows"),tn=async n=>{(0,l.existsSync)(k)&&(0,l.readdirSync)(k).forEach(e=>{e.startsWith("generated-")&&(0,l.unlinkSync)((0,S.join)(k,e))}),(0,l.mkdirSync)(k,{recursive:!0}),on(n).forEach(([e,r])=>{(0,l.writeFileSync)(e,r)})},L=tn;var w=u(m("child_process")),D=u(m("fs")),E=u(m("path"));var g=n=>process.stderr.isTTY?e=>`[${n}m${e}[0m`:e=>e,I=g(31),v=g(32),O=g(33),N=g(34),_=g(35),wn=g(36);var sn=["\u280B","\u2819","\u2839","\u2838","\u283C","\u2834","\u2826","\u2827","\u2807","\u280F"],an=n=>{let e=0,r=new Date().getTime();return setInterval(()=>{let o=`${((new Date().getTime()-r)/1e3).toFixed(1)}s`,t=n(o),a=sn[e%10];process.stderr.write(O(`${t} ${a}\r`)),e+=1},process.stderr.isTTY?40:1e3)},j=an;var cn=n=>{let e=(r,o)=>{let t=(0,w.spawnSync)("git",["diff",r,...o?[o]:[],"--name-only","--",n]).stdout.toString().trim();return t===""?[]:t.split(`
`)};return process.env.CI?e("HEAD^","HEAD"):e("origin/main")},ln=n=>JSON.parse((0,D.readFileSync)(n).toString()),pn=(n,e)=>{var t,a;let r=s=>{var i,p;return(0,E.dirname)(s)!==(0,E.join)((p=(i=n.information[e])==null?void 0:i.workspaceLocation)!=null?p:".","bin")};return((a=(t=n.information[e])==null?void 0:t.dependencyChain)!=null?a:[]).some(s=>{var d,c;let i=(c=(d=n.information[s])==null?void 0:d.workspaceLocation)!=null?c:".";return cn(i).some(r)})},dn=n=>n.topologicallyOrdered.map(e=>{let r=pn(n,e);return[e,r]}).filter(([,e])=>e).map(([e])=>e),mn=async()=>{let n=ln("workspaces.json"),e=dn(n);e.forEach(i=>{console.error(N(`[i] \`${i}\` needs to be recompiled.`))});let r=j(i=>`[?] Compiling (${i})`),t=await Promise.all(e.map(i=>{let p=(0,w.spawn)("yarn",["workspace",i,"compile"],{shell:!0,stdio:["ignore","pipe","ignore"]}),d="";return p.stdout.on("data",c=>{d+=c.toString()}),new Promise(c=>{p.on("exit",M=>c([i,M===0,d]))})}));clearInterval(r);let a=t.map(i=>i[2]).join(""),s=t.filter(i=>!i[1]).map(i=>i[0]);return s.length===0?(console.error(v("[\u2713] All workspaces have been successfully compiled!")),!0):(console.error(_("[!] Compilation finished with some errors.")),console.error(a.trim()),s.forEach(i=>{console.error(I(`[x] \`${i}\` failed to exit with 0.`))}),!1)},P=mn;var $=class extends q.Command{async execute(){return await P()?0:1}};$.paths=[["c"]];var fn={hooks:{afterAllInstalled:()=>{let n=(G(),B).default;(0,H.writeFileSync)("workspaces.json",`${JSON.stringify(n,void 0,2)}
