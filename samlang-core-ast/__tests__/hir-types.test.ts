...
it('isTheSameHighIRType works', () => {
  expect(isTheSameHighIRType(HIR_ANY_TYPE, HIR_STRING_TYPE)).toBeTruthy();
  expect(isTheSameHighIRType(HIR_STRING_TYPE, HIR_ANY_TYPE)).toBeTruthy();
  ...
  expect(isTheSameHighIRType(HIR_INT_TYPE, HIR_BOOL_TYPE)).toBeFalsy();
  expect(isTheSameHighIRType(HIR_INT_TYPE, HIR_INT_TYPE)).toBeTruthy();
  expect(isTheSameHighIRType(HIR_BOOL_TYPE, HIR_BOOL_TYPE)).toBeTruthy();
  expect(isTheSameHighIRType(HIR_BOOL_TYPE, HIR_INT_TYPE)).toBeFalsy();

  expect(isTheSameHighIRType(HIR_IDENTIFIER_TYPE('A'), HIR_ANY_TYPE)).toBeFalsy();
  ...
  expect(
    isTheSameHighIRType(HIR_FUNCTION_TYPE([HIR_INT_TYPE], HIR_BOOL_TYPE), HIR_INT_TYPE)
  ).toBeFalsy();
  expect(
    isTheSameHighIRType(
      HIR_FUNCTION_TYPE([HIR_INT_TYPE], HIR_BOOL_TYPE),
      HIR_FUNCTION_TYPE([HIR_BOOL_TYPE], HIR_INT_TYPE)
    )
  ).toBeFalsy();
  expect(
    isTheSameHighIRType(
      HIR_FUNCTION_TYPE([HIR_INT_TYPE], HIR_BOOL_TYPE),
      HIR_FUNCTION_TYPE([HIR_BOOL_TYPE], HIR_BOOL_TYPE)
    )
  ).toBeFalsy();
  expect(
    isTheSameHighIRType(
      HIR_FUNCTION_TYPE([HIR_INT_TYPE], HIR_BOOL_TYPE),
      HIR_FUNCTION_TYPE([], HIR_BOOL_TYPE)
    )
  ).toBeFalsy();
  expect(
    isTheSameHighIRType(
