...
const testCases: readonly (readonly [CompileTimeError, string])[] = [
  [
    new SyntaxError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 'bad code'),
    'Foo/Bar.sam:0:0-0:0: [SyntaxError]: bad code',
  ],
  [
    new UnexpectedTypeError(
      ModuleReference(['Foo', 'Bar']),
      Range.DUMMY,
  ...
  [
    new UnresolvedNameError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 'unresolvedName'),
    'Foo/Bar.sam:0:0-0:0: [UnresolvedName]: Name `unresolvedName` is not resolved.',
  ],
  [
    new UnsupportedClassTypeDefinitionError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 'object'),
  ...
  [
    new UnexpectedTypeKindError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 'array', 'object'),
  ...
  [
    new TupleSizeMismatchError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 1, 2),
    'Foo/Bar.sam:0:0-0:0: [TupleSizeMismatch]: Incorrect tuple size. Expected: 1, actual: 2.',
  ],
  [
    new TypeArgumentsSizeMismatchError(ModuleReference(['Foo', 'Bar']), Range.DUMMY, 1, 2),
    'Foo/Bar.sam:0:0-0:0: [TypeArgumentsSizeMismatch]: Incorrect type arguments size. Expected: 1, actual: 2.',
  ],
  [
    new InsufficientTypeInferenceContextError(ModuleReference(['Foo', 'Bar']), Range.DUMMY),
