...
const expectedErrors: readonly string[] = [
  ...
  'complete-trash.sam:1:1-1:5: [SyntaxError]: Unexpected token among the classes and interfaces.',
  'complete-trash.sam:1:11-1:14: [SyntaxError]: Unexpected token among the classes and interfaces.',
  'complete-trash.sam:1:15-1:21: [SyntaxError]: Unexpected token among the classes and interfaces.',
  'complete-trash.sam:1:21-1:22: [SyntaxError]: Unexpected token among the classes and interfaces.',
  'complete-trash.sam:1:6-1:8: [SyntaxError]: Unexpected token among the classes and interfaces.',
  'complete-trash.sam:1:9-1:10: [SyntaxError]: Unexpected token among the classes and interfaces.',
  ...
  'illegal-binary-operations.sam:21:52-21:54: [UnexpectedType]: Expected: `bool`, actual: `int`.',
