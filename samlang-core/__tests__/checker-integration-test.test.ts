...
const expectedErrors: readonly string[] = [
  ...
  'complete-trash.sam:1:21-1:22: [SyntaxError]: Unexpected token among the classes.',
  'complete-trash.sam:1:6-1:8: [SyntaxError]: Unexpected token among the classes.',
  'complete-trash.sam:1:9-1:10: [SyntaxError]: Unexpected token among the classes.',
