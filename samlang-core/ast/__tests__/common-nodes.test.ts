...
describe('common-nodes', () => {
  ...
  it('prettyPrint is working.', () => {
    ...
    expect(prettyPrintType(functionType([intType, boolType], boolType))).toBe(
      '(int, bool) -> bool'
    );
  ...
  it('type equality test', () => {
    ...
    expect(
      isTheSameType(tupleType([intType, boolType]), tupleType([boolType, intType]))
    ).toBeFalsy();
    expect(
    ...
    expect(
      isTheSameType(functionType([intType], boolType), functionType([], boolType))
    ).toBeFalsy();
    expect(
