      ...
      vec![
        ...
        Statement::IfElse {
          ...
          final_assignments: vec![IfElseFinalAssignment {
            ...
            type_: INT_32_TYPE,
            e1: Expression::var_name(heap.alloc_str_for_test("i1"), INT_32_TYPE),
            e2: Expression::var_name(heap.alloc_str_for_test("i2"), INT_32_TYPE),
          }],
        },
      ],
      ZERO,
      ...
      vec![Statement::While {
        ...
        statements: vec![
          ...
          Statement::IfElse {
            ...
            final_assignments: vec![
              IfElseFinalAssignment { name: PStr::LOWER_C, type_: INT_32_TYPE, e1: ZERO, e2: ONE },
              IfElseFinalAssignment {
