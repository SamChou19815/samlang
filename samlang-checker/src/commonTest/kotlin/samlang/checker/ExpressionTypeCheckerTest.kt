...
class ExpressionTypeCheckerTest {
    @Test
    fun simpleLiteralTypeChecksUnderCorrectExpectedType() {
    ...
    @Test
    fun simpleLiteralDoesNotTypeCheckUnderWrongExpectedType() {
        assertCheck(
            source = "true",
            expectedType = unit,
    ...
    @Test
    fun thisNotInsideAMethodDoesNotTypeCheck() {
        assertCheck(
            source = "this",
            expectedType = int,
    ...
    @Test
    fun undefinedVariableDoesNotTypeCheck() {
        assertCheck(
            source = "foo",
            expectedType = int,
    ...
    @Test
    fun definedVariableWithCorrectExpectedTypeTypeChecks() {
        assertCheck(source = "{ val foo = 3; foo }", expectedType = int)
    }

    @Test
    fun definedVariableWithWrongExpectedTypeDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun definedClassMemberTypeChecks() {
        assertCheck(
    ...
    @Test
    fun undefinedClassMemberDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun goodTupleConstructorTypeChecks() {
        assertCheck(
            source = "[1, 2, 3]",
    ...
    @Test
    fun tupleConstructorWithWrongExpectedTypeDoesNotTypeCheck() {
        assertCheck(
            source = "[1, 2, 3]",
    ...
    @Test
    fun goodFieldConstructorWithCorrectFieldTypesTypeChecks() {
    ...
    @Test
    fun badFieldConstructorWithWrongFieldTypedDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun fieldConstructorWithNonIdentifierTypeAsExpectedTypeDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun constructVariantInsideObjectClassDoesNotTypeCheck() {
        assertCheck(
            source = "Foo(true)",
    ...
    @Test
    fun goodFieldAndMethodAccessTypeChecks() {
    ...
    @Test
    fun fieldAndMethodAccessWithBadExpectedTypeDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun fieldAndMethodAccessWithInsufficientTypeInfoDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun goodUnaryExpressionsTypeCheck() {
    ...
    @Test
    fun badUnaryExpressionsDoNotTypeCheck() {
        assertCheck(
            source = "-(false)",
            expectedType = int,
    ...
    @Test
    fun panicWithStringArgumentTypeChecks() {
    ...
    @Test
    fun panicWithNonStringArgumentDoesNotTypeCheck() {
        assertCheck(
            source = "panic(3)",
            expectedType = unit,
    ...
    @Test
    fun goodFunctionApplicationTypeChecks() {
    ...
    @Test
    fun callingANonFunctionDoesNotTypeCheck() {
        assertCheck(
            source = "3(3)",
            expectedType = unit,
            expectedErrors = listOf(
    ...
    @Test
    fun functionApplicationWithBadArgumentsDoesNotTypeCheck() {
        assertCheck(
    ...
    @Test
    fun functionApplicationWithBadReturnTypeDoesNotTypeCheck() {
        assertCheck(
            source = "Test.helloWorld(\"\")",
            expectedType = bool,
            expectedErrors = listOf(
    ...
    @Test
    fun goodBinaryExpressionsTypeCheck() {
    ...
    @Test
    fun binaryExpressionsWithBadArgumentsDoNotTypeCheck() {
        assertCheck(
            source = "\"1\" * \"1\"",
            expectedType = int,
            expectedErrors = listOf(
    ...
    @Test
    fun binaryExpressionsWithBadExpectedTypeDoNotTypeCheck() {
        assertCheck(
            source = "1 * 1",
            expectedType = unit,
    ...
    @Test
    fun matchVariantInsideObjectClassDoesNotTypeCheck() {
        assertCheck(
    ...
    private companion object {
        ...
        fun assertCheck(
            ...
            if (expectedExpression != null) {
                assertEquals(expected = expectedExpression, actual = actualExpression)
            }
            ...
            assertEquals(expected = expectedErrors, actual = transformedActualErrors)
        }
    }
}
