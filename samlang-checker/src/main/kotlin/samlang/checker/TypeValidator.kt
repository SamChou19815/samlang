...
/** Exposed for test */
internal fun validateType(type: Type, identifierTypeValidator: IdentifierTypeValidator): String? {
    val visitor = TypeValidator()
...
private class TypeValidator : TypeVisitor<IdentifierTypeValidator, Boolean> {
