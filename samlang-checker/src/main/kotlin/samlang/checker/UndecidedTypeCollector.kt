...
internal object UndecidedTypeCollector {
    /** @return a list of all appeared undecided type indices in [type]. */
    fun collectUndecidedTypeIndices(type: Type): List<Int> {
    ...
    private class UndecidedTypeCollectorVisitor : TypeVisitor<Unit, Unit> {
        ...
        override fun visit(type: PrimitiveType, context: Unit): Unit = Unit

        override fun visit(type: IdentifierType, context: Unit): Unit =
