...
it('optimizeIRWithConstantPropagation test 1', () => {
  expect(
    optimizeIRWithConstantPropagation([
      ...
      MIR_MOVE_TEMP('z1', MIR_OP('+', MIR_ONE, MIR_ZERO)),
      MIR_MOVE_TEMP('z2', MIR_OP('!=', MIR_ONE, MIR_ZERO)),
      MIR_MOVE_IMMUTABLE_MEM(MIR_TEMP('z2'), MIR_OP('!=', MIR_ONE, MIR_ZERO)),
      MIR_JUMP('end'),
      MIR_LABEL('true'),
      MIR_MOVE_TEMP('y', MIR_OP('+', MIR_ONE, MIR_TEMP('x'))),
      MIR_MOVE_TEMP('z1', MIR_OP('*', MIR_ONE, MIR_ONE)),
      MIR_MOVE_TEMP('z2', MIR_OP('/', MIR_ONE, MIR_IMMUTABLE_MEM(MIR_ZERO))),
