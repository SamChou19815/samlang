...
const statements: readonly MidIRStatement[] = [
  ...
  /* 03 */ MIR_MOVE_IMMUTABLE_MEM(MIR_TEMP('z2'), MIR_OP('+', MIR_ONE, MIR_TEMP('x'))),
  /* 04 */ MIR_JUMP('r'),
  /* 05 */ MIR_LABEL('r'),
  /* 06 */ MIR_JUMP('end'),
  /* 07 */ MIR_LABEL('true'),
...
it('computeGlobalExpressionUsageAndAppearMap test 2', () => {
  expect(
    computeGlobalExpressionUsageAndAppearMap_EXPOSED_FOR_TESTING([MIR_RETURN(MIR_ONE)]).size
  ).toBe(0);
});
  ...
  expect(
    optimizeIRWithCommonSubExpressionElimination(
      [
        ...
        MIR_MOVE_TEMP('y', MIR_OP('+', MIR_IMMUTABLE_MEM(MIR_ONE), MIR_IMMUTABLE_MEM(MIR_ONE))),
        MIR_RETURN(
          MIR_OP(
            '/',
            MIR_OP(
...
it('optimizeIRWithCommonSubExpressionElimination test 4', () => {
  expect(
    optimizeIRWithCommonSubExpressionElimination(
      [
        MIR_MOVE_TEMP('x', MIR_OP('+', MIR_IMMUTABLE_MEM(MIR_ZERO), MIR_IMMUTABLE_MEM(MIR_ONE))),
