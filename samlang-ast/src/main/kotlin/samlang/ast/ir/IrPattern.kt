...
sealed class IrPattern {
    ...
    data class VariablePattern(val name: String) : IrPattern() {
        override fun prettyPrint(): String = name
    }

    /** A wildcard pattern `_` that matches everything. */
    object WildCardPattern : IrPattern() {
