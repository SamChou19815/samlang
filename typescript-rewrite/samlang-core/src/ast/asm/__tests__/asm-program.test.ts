...
it('assemblyProgramToString test', () => {
  expect(assemblyProgramToString(program, 'linux')).toBe(`    .text
...
`);
  ...
  expect(assemblyProgramToString(program, 'macos')).toBe(`    .text
    .intel_syntax noprefix
    .p2align 4, 0x90
    .align 8
    .globl _compiled_program_main
...
`);
  ...
  expect(assemblyProgramToString(program, 'windows')).toBe(`    .text
    .intel_syntax noprefix
    .p2align 4, 0x90
    .align 8
    .globl _compiled_program_main
